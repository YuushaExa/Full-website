...
document.querySelector(".cover").style.backgroundImage = `linear-gradient(to top, ${bg} 0, rgba(20, 38, 51, 0.1) 60%), url('${bg_url}')`;    document.querySelector(".cover").style.backgroundPosition = "center";
