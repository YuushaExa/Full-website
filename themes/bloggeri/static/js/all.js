...
var favoriteButton = document.querySelector('.toggleButton');

// Add event listeners for mouseenter and mouseleave events
favoriteButton.addEventListener('mouseenter', function() {
  // Create the label container <div> element
  var labelContainer = document.createElement('div');
  labelContainer.classList.add('labelContainer');

  // Get the aria-label attribute value
  var ariaLabel = favoriteButton.getAttribute('aria-label');
  
  // Set the text content of the label container
  labelContainer.textContent = ariaLabel;

  // Append the label container to the document body
  document.body.appendChild(labelContainer);
});

favoriteButton.addEventListener('mouseleave', function() {
  // Remove the label container from the document body
  var labelContainer = document.querySelector('.labelContainer');
  if (labelContainer) {
