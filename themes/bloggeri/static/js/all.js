...
const link = document.querySelector('.toggleButton');
...
link.addEventListener('mouseover', function() {
  ...
  const tooltipTop = linkRect.top + linkRect.height;
  const tooltipLeft = linkRect.left + (linkRect.width - tooltipRect.width) / 2;
