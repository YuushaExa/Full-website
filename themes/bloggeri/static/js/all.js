$('.card-image a').hover(function (event) { 
  ...
  var link1 =  $(this).attr('href');
    $(this).append('<div id="game-preview"><a href="'+ link1 +'"><svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 96 960 960" width="24"><path fill="#fff" d="M484 809q16 0 27-11t11-27-11-27-27-11-27 11-11 27 11 27 27 11zm-35-146h59q0-26 6.5-47.5T555 566q31-26 44-51t13-55q0-53-34.5-85T486 343q-49 0-86.5 24.5T345 435l53 20q11-28 33-43.5t52-15.5q34 0 55 18.5t21 47.5q0 22-13 41.5T508 544q-30 26-44.5 51.5T449 663zm31 313q-82 0-155-31.5t-127.5-86-86-127.5T80 576q0-83 31.5-156t86-127T325 207.5 480 176q83 0 156 31.5T763 293t85.5 127T880 576q0 82-31.5 155T763 858.5t-127 86T480 976zm0-60q142 0 241-99.5T820 576q0-142-99-241t-241-99q-141 0-240.5 99T140 576q0 141 99.5 240.5T480 916zm0-340z"></path></svg></a></div>');
    }, function() {
    $('#game-preview').remove();
});
