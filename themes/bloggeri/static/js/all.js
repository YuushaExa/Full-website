...
//
// Step 1: Check if there is a value in localStorage for "Notes"
var storedNotes = localStorage.getItem("Notes");

if (storedNotes) {
  // Step 2: Retrieve the link value from the card and compare it with storedNotes
  ...
  cards.forEach(function(card) {
    ...
    if (href === storedNotes) {
      // Step 3: Create a new div element with class "NotesRead"
      var notesReadDiv = document.createElement('div');
      notesReadDiv.className = 'NotesRead';

      // Step 4: Append the "NotesRead" div under the card
