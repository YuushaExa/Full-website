...
document.body.addEventListener("click", async function (event) {
  const target = event.target.closest(".card a");
  if (target) {
...
const contentFrontElement = document.querySelector("#content-front");
const contentFrontTextElement = document.querySelector("#content-front-text");
