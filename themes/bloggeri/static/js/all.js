...
container.addEventListener("mouseenter", function() {
  ...
  var tooltipText = container.getAttribute("data-title");
  ...
  // Create the dynamically generated div
  var dynamicDiv = document.createElement("div");
  dynamicDiv.textContent = "Dynamic Div";
...
container.addEventListener("mouseleave", function() {
  ...
  // Remove the dynamically generated div
  var dynamicDiv = container.querySelector("div");
  if (dynamicDiv) {
