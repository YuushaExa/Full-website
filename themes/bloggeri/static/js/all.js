...
//
// Function to update the rating displays
...
function handleStarClick(event) {
  ...
  var ratingDisplay2 = card.querySelector('.rating-menu2');
ratingDisplay2.textContent = '★' + (existingRating ? existingRating.rating : "Not rated");
}
