var galleryImages = document.querySelectorAll('.tabcontent img');
var currentIndex = 0;
...
var gallery = document.querySelector('.tabcontent');
...
function prevSlide() {
  ...
  var loadingTimeout = setTimeout(function() {
    ...
    element123.style.animation = 'slideAnimation1 0.5s forwards';
  setTimeout(function() {
lightboxImg.style.display = 'none';
  }, 510);
  ...
  // Apply the animation for sliding back after 1 second
  setTimeout(function() {
    element123.style.animation = 'slideAnimationBack1 0.5s forwards';
  }, 510);
